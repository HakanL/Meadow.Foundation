    ...
    public static partial class Native
    {
        ...
        public struct ControlTransferCommand
        {
            ...
            public ControlTransferCommand(ushort function, byte[] databuf)
            {
                ...
                if (databuf.Length > 32)
                { throw new ArgumentException("Maximum buffer lenght is 32 byte"); }
        ...
        public struct SetupPacket
        {
            ...
            {
                if (databuf.Length < 8)
                { throw new ArgumentException("Minimum data lenght for SetupPacket is 8 byte"); }
