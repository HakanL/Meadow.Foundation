...
/// <summary>
/// Represents a CH341A USB IO Expander
/// </summary>
    ...
    ISpiController
{
    ...
    /// <summary>
    /// Finalizes native resources for the Ch341
    /// </summary>
    ~Ch341()
    {
        Dispose(false);
    ...
    internal void ClearState(byte key)
    {
        _portState = (byte)(_portState & ~key);
        Set_D5_D0(_direction, _portState);
    }

    internal void SetState(byte key)
    {
        _portState = (byte)(_portState | key);
        Set_D5_D0(_direction, _portState);
    }
    ...
    public bool OpenDevice()
    {
        ...
        IntPtr handler = Functions.CH341OpenDevice(_Index);
        if (((int)handler) == -1)
        { _IsOpen = false; }
        else
        { _IsOpen = true; }
    ...
    {
        Functions.CH341CloseDevice(_Index);
        _IsOpen = false;
    }
    ...
    {
        return Functions.CH341GetVersion();
    }
    ...
    {
        if (_IsOpen == false)
        { throw new System.InvalidOperationException(MessageRequiredToOpenDevice); }
        return Functions.CH341GetDrvVersion();
    }
    ...
    {
        IntPtr devName = Functions.CH341GetDeviceName(_Index);
    ...
    public IC_VER GetVerIC()
    {
        ...
        return (IC_VER)Functions.CH341GetVerIC(_Index);
    }
    ...
    public bool SetExclusive(uint iExclusive)
    {
        ...
        return Functions.CH341SetExclusive(_Index, iExclusive);
    }
    ...
    public bool SetStream(uint iMode)
    {
        ...
        return Functions.CH341SetStream(_Index, iMode);
    }
    ...
    public bool SetDelaymS(uint iDelay)
    {
        ...
        return Functions.CH341SetDelaymS(_Index, iDelay);
    }
    ...
    public uint CH341DriverCommand(ref ControlTransferCommand ioCommand)
    {
        ...
        uint opResult = Functions.CH341DriverCommand(_Index, iocmd);
    ...
    public bool SetTimeout(uint iWriteTimeout, uint iReadTimeout)
    {
        ...
        return Functions.CH341SetTimeout(_Index, iWriteTimeout, iReadTimeout);
    }
    ...
    public bool ReadData(out byte[] oBuffer)
    {
        ...
        bool opResult = Functions.CH341ReadData(_Index, ptrBuffer, out ioLength);
    ...
    public bool WriteData(byte[] iBuffer)
    {
        ...
        return Functions.CH341WriteData(_Index, iBufferPtr, out ioLength);
    }
    ...
    public bool WriteRead(byte[] iWriteBuffer, uint iReadStep, uint iReadTimes, out byte[] oReadBuffer)
    {
        ...
        bool opResult = Functions.CH341WriteRead(_Index, iWriteLength, iWriteBufferPtr, iReadStep, iReadTimes, out oReadLength, oReadBufferPtr);
    ...
    public bool FlushBuffer()
    {
        ...
        return Functions.CH341FlushBuffer(_Index);
    }
    ...
    public bool ResetDevice()
    {
        if (_IsOpen == false)
        { throw new System.InvalidOperationException(MessageRequiredToOpenDevice); }
        return Functions.CH341ResetDevice(_Index);
    }
    ...
    public bool ResetRead()
    {
        ...
        return Functions.CH341ResetRead(_Index);
    }
    ...
    public bool ResetWrite()
    {
        ...
        return Functions.CH341ResetWrite(_Index);
    }
    ...
    public bool GetDeviceDescr(out byte[] oBuffer)
    {
        ...
        bool opResult = Functions.CH341GetDeviceDescr(_Index, ptrBuffer, out ioLength);
    ...
    public bool GetConfigDescr(out byte[] obuf)
    {
        ...
        bool opResult = Functions.CH341GetConfigDescr(_Index, oBuffer, out ioLength);
    ...
    public bool SetBufUpload(uint iEnableOrClear)
    {
        ...
        return Functions.CH341SetBufUpload(_Index, iEnableOrClear);
    }
    ...
    public int QueryBufUpload()
    {
        ...
        return Functions.CH341QueryBufUpload(_Index);
    }
    ...
    public bool SetBufDownload(uint iEnableOrClear)
    {
        ...
        return Functions.CH341SetBufDownload(_Index, iEnableOrClear);
    }
    ...
    public int QueryBufDownload()
    {
        ...
        return Functions.CH341QueryBufDownload(_Index);
    }
    ...
    public bool ReadInter(out uint iStatus)
    {
        ...
        return Functions.CH341ReadInter(_Index, out iStatus);
    }
    ...
    public bool AbortInter()
    {
        ...
        return Functions.CH341AbortInter(_Index);
    }
    ...
    public bool ResetInter()
    {
        ...
        return Functions.CH341ResetInter(_Index);
    }
    ...
    public bool InitParallel(uint iMode)
    {
        ...
        return Functions.CH341InitParallel(_Index, iMode);
    }
    ...
    public bool SetParaMode(uint iMode)
    {
        ...
        return Functions.CH341SetParaMode(_Index, iMode);
    }
    ...
    public bool GetStatus(out uint iStatus)
    {
        ...
        return Functions.CH341GetStatus(_Index, out iStatus);
    }
    ...
    public bool AbortRead()
    {
        ...
        return Functions.CH341AbortRead(_Index);
    }
    ...
    public bool AbortWrite()
    {
        ...
        return Functions.CH341AbortWrite(_Index);
    }
    ...
    public bool ReadData0(UInt32 ioLength, out byte[] obuf)
    {
        ...
        bool opResult = Functions.CH341ReadData0(_Index, oBuffer, ref tLength);
    ...
    public bool ReadData1(UInt32 ioLength, out byte[] obuf)
    {
        ...
        bool opResult = Functions.CH341ReadData1(_Index, oBuffer, ref tLength);
    ...
    public bool WriteData0(byte[] iBuffer)
    {
        ...
        return Functions.CH341WriteData0(_Index, iBufferPtr, out ioLength);
    }
    ...
    public bool WriteData1(byte[] iBuffer)
    {
        ...
        return Functions.CH341WriteData1(_Index, iBufferPtr, out ioLength);
    }
    ...
    public bool EppReadData(UInt32 ioLength, out byte[] obuf)
    {
        ...
        bool opResult = Functions.CH341EppReadData(_Index, oBuffer, out tLength);
    ...
    public bool EppReadAddr(UInt32 ioLength, out byte[] obuf)
    {
        ...
        bool opResult = Functions.CH341EppReadAddr(_Index, oBuffer, out tLength);
    ...
    public bool EppWriteData(byte[] iBuffer)
    {
        ...
        return Functions.CH341EppWriteData(_Index, iBufferPtr, out ioLength);
    }
    ...
    public bool EppWriteAddr(byte[] iBuffer)
    {
        ...
        return Functions.CH341EppWriteAddr(_Index, iBufferPtr, out ioLength);
    }
    ...
    public bool EppSetAddr(byte iAddr)
    {
        ...
        return Functions.CH341EppSetAddr(_Index, iAddr);
    }
    ...
    public bool MemReadAddr0(UInt32 ioLength, out byte[] obuf)
    {
        ...
        bool opResult = Functions.CH341MemReadAddr0(_Index, oBuffer, out tLength);
    ...
    public bool MemReadAddr1(UInt32 ioLength, out byte[] obuf)
    {
        ...
        bool opResult = Functions.CH341MemReadAddr1(_Index, oBuffer, out tLength);
    ...
    public bool MemWriteAddr0(byte[] iBuffer)
    {
        ...
        return Functions.CH341MemWriteAddr0(_Index, iBufferPtr, out ioLength);
    }
    ...
    public bool MemWriteAddr1(byte[] iBuffer)
    {
        ...
        return Functions.CH341MemWriteAddr1(_Index, iBufferPtr, out ioLength);
    }
    ...
    public bool GetInput(out uint iStatus)
    {
        ...
        return Functions.CH341GetInput(_Index, out iStatus);
    }
    ...
    public bool SetOutput(uint iEnable, uint iSetDirOut, uint iSetDataOut)
    {
        ...
        return Functions.CH341SetOutput(_Index, iEnable, iSetDirOut, iSetDataOut);
    }
    ...
    public bool Set_D5_D0(uint iSetDirOut, uint iSetDataOut)
    {
        ...
        return Functions.CH341Set_D5_D0(_Index, iSetDirOut, iSetDataOut);
    }
    ...
    /// <returns></returns>
    public bool StreamSPI3(uint iChipSelect, byte[] ioBuffer)
    {
        if (_IsOpen == false)
        { throw new System.InvalidOperationException(MessageRequiredToOpenDevice); }
        ...
        bool opResult = Functions.CH341StreamSPI3(_Index, iChipSelect, iLength, ioBufferPtr);
    ...
    */
    ...
    /// <returns></returns>
    public bool StreamSPI4(uint iChipSelect, byte[] ioBuffer)
    {
        if (_IsOpen == false)
        { throw new System.InvalidOperationException(MessageRequiredToOpenDevice); }
        ...
        bool opResult = Functions.CH341StreamSPI4(_Index, iChipSelect, iLength, ioBufferPtr);
    ...
    /// <returns></returns>
    public bool StreamSPI5(uint iChipSelect, uint iLength, byte[] ioBuffer, byte[] ioBuffer2)
    {
        if (_IsOpen == false)
        { throw new System.InvalidOperationException(MessageRequiredToOpenDevice); }
        if (iLength > ioBuffer.Length)
        { throw new System.ArgumentOutOfRangeException("iLength < ioBuffer.Length"); }
        if (iLength > ioBuffer2.Length)
        { throw new System.ArgumentOutOfRangeException("iLength < ioBuffer2.Length"); }
        ...
        bool opResult = Functions.CH341StreamSPI5(_Index, iChipSelect, iLength, ioBufferPtr, ioBuffer2Ptr);
    ...
    */
    ...
    /// <returns></returns>
    public bool BitStreamSPI(uint iLength, byte[] ioBuffer)
    {
        if (_IsOpen == false)
        { throw new System.InvalidOperationException(MessageRequiredToOpenDevice); }
        ...
        bool opResult = Functions.CH341BitStreamSPI(_Index, iLength, ioBufferPtr);
    ...
    public bool ReadEEPROM(EEPROM_TYPE iEepromID, uint iAddr, uint iLength, out byte[] oBuffer)
    {
        ...
        bool opResult = Functions.CH341ReadEEPROM(_Index, (uint)iEepromID, iAddr, iLength, oBufferPtr);
    ...
    public bool WriteEEPROM(EEPROM_TYPE iEepromID, uint iAddr, uint iLength, byte[] iBuffer)
    {
        ...
        return Functions.CH341WriteEEPROM(_Index, (uint)iEepromID, iAddr, iLength, oBufferPtr);
    }
    ...
    public bool ReadI2C(byte iDevice, byte iAddr, out byte oByte)
    {
        ...
        return Functions.CH341ReadI2C(_Index, iDevice, iAddr, out oByte);
    }
    ...
    public bool WriteI2C(byte iDevice, byte iAddr, byte iByte)
    {
        ...
        return Functions.CH341WriteI2C(_Index, iDevice, iAddr, iByte);
    }
    ...
    public bool StreamI2C(byte[] iWriteBuffer, uint iReadLength, out byte[] oReadBuffer)
    {
        ...
        bool opResult = Functions.CH341StreamI2C(_Index, iWriteLength, iWriteBufferPtr, iReadLength, oReadBufferPtr);
    ...
    public bool IIC_OutByteCheckAck(byte iOutByte)
    {
        ...
        {
            if (mReadBuf.Length > 0 && (mReadBuf[mReadBuf.Length - 1] & 0x80) == 0)
            { return true; }
        }
    ...
    public bool IIC_InBlockByAck(uint iInLength, out byte[] iOutBuffer)
    {
        ...
        if (iInLength == 0)
        { throw new System.ArgumentOutOfRangeException("iInLength == 0"); }

        if (iInLength > mCH341A_CMD_I2C_STM_MAX)
        { throw new System.ArgumentOutOfRangeException("iInLength > mCH341A_CMD_I2C_STM_MAX"); }
    ...
    public bool SetupSerial(uint iParityMode, uint iBaudRate)
    {
        ...
        return Functions.CH341SetupSerial(_Index, iParityMode, iBaudRate);
    }
    ...
    public IDigitalOutputPort CreateDigitalOutputPort(IPin pin, bool initialState = false, OutputType initialOutputType = OutputType.PushPull)
    {
        ...
        Set_D5_D0(d, _portState);
        _direction = d;
        //            _stateMask |= (byte)pin.Key;

        return new Ch341DigitalOutputPort(pin, (pin.SupportedChannels.First(c => c is DigitalChannelInfo) as IDigitalChannelInfo)!, initialState, initialOutputType, this);
    }

    public ISpiBus CreateSpiBus(int channel, SpiClockConfiguration configuration)
    {
        OpenDevice();

        // TODO: make sure no SPI is in use
        var bus = new Ch341SpiBus(this, configuration);
        bus.Configure();

        _direction = 0b00111111;
        Set_D5_D0(_direction, _portState);
